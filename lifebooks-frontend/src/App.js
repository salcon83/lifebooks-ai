        ...
        <Router>
            <div className="App">
                <Routes>
                    ...
                    <Route path="/story/:id?" element={user ? <StoryEditor user={user} /> : <Navigate to="/login" />} />
                    <Route path="/create-story-type" element={user ? <StoryTypeSelector user={user} /> : <Navigate to="/login" />} />
